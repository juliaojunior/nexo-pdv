      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 w-full pb-20">
        ...
        <div className="flex flex-col items-center gap-3 mb-2">
          ...
          <div className="flex gap-3">
             <label className="flex items-center gap-2 bg-surface-raised border border-border/50 text-foreground px-4 py-2.5 rounded-xl cursor-pointer active:scale-95 transition-all shadow-sm">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input 
              ...
              className={`w-full bg-surface-raised rounded-xl py-3.5 px-4 outline-none text-foreground font-medium border ${errors.name ? 'border-danger focus:ring-1 focus:ring-danger' : 'border-border/50 focus:border-primary focus:ring-1 focus:ring-primary'}`}
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea 
              ...
              rows={3}
              className={`w-full bg-surface-raised rounded-xl py-3.5 px-4 outline-none text-foreground font-medium border resize-none ${errors.description ? 'border-danger focus:ring-1 focus:ring-danger' : 'border-border/50 focus:border-primary focus:ring-1 focus:ring-primary'}`}
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select 
              ...
              className={`w-full bg-surface-raised rounded-xl py-3.5 px-4 outline-none text-foreground font-medium border appearance-none ${errors.categoryId ? 'border-danger focus:ring-1 focus:ring-danger' : 'border-border/50 focus:border-primary focus:ring-1 focus:ring-primary'}`}
            >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                step="0.01"
                placeholder="0.00"
                className={`w-full bg-surface-raised rounded-xl py-3.5 pl-12 pr-4 outline-none text-foreground font-medium border ${errors.price ? 'border-danger focus:ring-1 focus:ring-danger' : 'border-border/50 focus:border-primary focus:ring-1 focus:ring-primary'}`}
              />
            </div>
          ...
          <div className="flex flex-col gap-1.5 mt-2">
            ...
            <div className="flex gap-2">
              <input 
                ...
                className={`w-full bg-surface-raised rounded-xl py-3.5 pl-4 pr-3 outline-none text-foreground font-medium border ${errors.barcode ? 'border-danger focus:ring-1 focus:ring-danger' : 'border-border/50 focus:border-primary focus:ring-1 focus:ring-primary'}`}
              />
              <button 
                type="button" 
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input 
              ...
              type="number"
              placeholder="0"
              className={`w-full bg-surface-raised rounded-xl py-3.5 px-4 outline-none text-foreground font-medium border ${errors.stock ? 'border-danger focus:ring-1 focus:ring-danger' : 'border-border/50 focus:border-primary focus:ring-1 focus:ring-primary'}`}
            />
