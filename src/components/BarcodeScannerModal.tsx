        ...
        <div className="relative w-full aspect-square rounded-3xl overflow-hidden bg-black ring-4 ring-surface-raised ring-offset-2 ring-offset-black shadow-[0_0_40px_rgba(6,182,212,0.15)] flex flex-col items-center justify-center">
          ...
          {error ? (
            <div className="flex flex-col items-center p-6 text-center">
              <CameraOff size={48} className="text-danger mb-4" />
          ...
          {!error && (
            <div className="absolute inset-0 z-10 pointer-events-none flex items-center justify-center">
               <div className="w-[80%] h-[30%] border-2 border-dashed border-primary rounded-xl relative">
                  <div className="absolute -top-1 -left-1 w-4 h-4 border-t-4 border-l-4 border-primary-bright rounded-tl-xl"></div>
                  <div className="absolute -top-1 -right-1 w-4 h-4 border-t-4 border-r-4 border-primary-bright rounded-tr-xl"></div>
                  <div className="absolute -bottom-1 -left-1 w-4 h-4 border-b-4 border-l-4 border-primary-bright rounded-bl-xl"></div>
                  <div className="absolute -bottom-1 -right-1 w-4 h-4 border-b-4 border-r-4 border-primary-bright rounded-br-xl"></div>
               </div>
            </div>
          )}
        </div>
