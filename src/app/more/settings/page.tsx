      ...
      <main className="px-4 pt-6 max-w-md mx-auto flex flex-col gap-8">
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="bg-surface border border-border/30 rounded-2xl p-4 flex flex-col gap-4 shadow-sm">
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold text-muted uppercase tracking-widest pl-1">Documento Comercial (CNPJ / CPF)</label>
              <input 
                type="text" 
                value={storeDocument}
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold text-muted uppercase tracking-widest pl-1">WhatsApp de Contato Oficial</label>
              <input 
                type="tel" 
                value={storePhone}
      ...
      {isCatModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center sm:justify-center overflow-hidden">
          ...
          <div className="relative w-full sm:max-w-md bg-background sm:rounded-3xl rounded-t-3xl border-t sm:border border-border/50 shadow-overlay flex flex-col h-[90vh] sm:h-[80vh] animate-in slide-in-from-bottom-full duration-300 mx-auto">
            ...
            {/* Editor Box */}
            <form onSubmit={handleSaveCategory} className="p-4 border-t border-border/30 bg-surface shrink-0 mb-safe sm:mb-0">
              <div className="flex items-center justify-between mb-2">
                 <span className="text-xs font-bold text-primary-bright uppercase tracking-widest pl-1">
              ...
              <div className="flex gap-2">
                 ...
                 <button 
                  ...
                  className="w-14 h-14 shrink-0 bg-primary text-primary-deep font-black rounded-xl flex items-center justify-center active:scale-95 transition-transform disabled:opacity-50 disabled:bg-border disabled:text-muted"
                 >
