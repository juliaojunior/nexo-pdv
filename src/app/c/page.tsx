    ...
    <div className="min-h-screen bg-background flex items-center justify-center font-[Inter] text-white p-4 text-center">
      <div className="bg-surface border border-border/30 p-8 rounded-3xl w-full max-w-sm flex flex-col gap-4 shadow-2xl">
         ...
         <p className="text-muted text-sm font-medium leading-relaxed">
            Esta é a base do servidor de Catálogos da Nexo. <br/>Para visualizar os produtos e realizar pedidos, você precisa do link completo fornecido pela loja (exemplo: <span className="text-white font-bold bg-surface-raised px-1 rounded">nexo.vercel.app/c/ID_DA_LOJA</span>).
         </p>
      </div>
    </div>
  );
