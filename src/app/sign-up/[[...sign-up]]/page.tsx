      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <SignUp forceRedirectUrl="/" appearance={{
          elements: {
            ...
            socialButtonsBlockButton: "border border-border/50 text-white hover:bg-surface-raised",
            socialButtonsBlockButtonText: "text-white font-medium",
            dividerLine: "bg-border/50",
            dividerText: "text-muted",
            formFieldLabel: "text-muted",
            formFieldInput: "bg-surface-raised border-border/50 text-white focus:border-primary-bright rounded-xl",
