            ...
            <div className="w-full flex flex-col items-center justify-center min-h-[56px]">
              ...
              <ClerkLoaded>
                <button 
                  ...
                  className="w-full h-12 sm:h-14 bg-white text-[#1f1f1f] flex items-center justify-center gap-3 sm:gap-4 rounded-lg font-bold text-[13px] sm:text-base transition-[all_0.2s_ease-out] active:scale-95 hover:bg-gray-200 shadow-md transform-gpu px-2"
                >
